...
import com.lgh.wine.WineApplication;

/**
 * 类描述：字符串操作相关工具类
 * 创建人：rjf
 * 创建时间：2018/6/25 11:21.
 * 修改人：
 * 修改时间
 * 修改备注
 */
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(WineApplication.getAppContext(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(WineApplication.getAppContext(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(WineApplication.getAppContext(), resourceId), start, end, flag);
                    resourceId = 0;
