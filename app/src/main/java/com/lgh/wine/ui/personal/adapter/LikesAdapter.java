 ...
 * 模块：
 */
public class LikesAdapter extends BaseRecyclerAdapter<UserArticleBean, LikesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        UserArticleBean item = getItem(position);
        holder.tvName.setText(item.getGoods_name());
        holder.tvContent.setText(item.getGoods_name());
        GlideHelper.loadImage(mContext, holder.iv_pic, Constant.IMG_IP + item.getGoods_icon());
