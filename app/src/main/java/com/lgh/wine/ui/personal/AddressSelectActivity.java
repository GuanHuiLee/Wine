...
import com.lgh.wine.ui.personal.adapter.AddressSelectAdapter;
...
public class AddressSelectActivity extends BaseActivity implements AddressContract.View, OnRefreshListener {
    ...
    protected void initUI() {
        ...
        mAddressAdapter.setOnChildClickListener(new AddressSelectAdapter.OnChildClickListener() {
            @Override
